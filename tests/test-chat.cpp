...
static void test_reasoning_sampling_per_request() {
    ...
    assert_equals(128, params.sampling.reasoning_penalty_last_n);
    ...
    assert_equals(256, params.sampling.reasoning_dry_penalty_last_n);
